...
const UserSingup = () => {
  ...
  return (
    <div className="h-screen w-screen bg-white">
      ...
      action="" className="mt-10 mr-5 ml-5 flex flex-col ">
      ...
      <label htmlFor="" className="text-xl font-semibold"> First Name</label>
       ...
       className=" mt-2 mb-4  w-full bg-gray-100 text-lg p-2.5 rounded outline-none"
       /></div>
      <div>
      <label htmlFor="" className="text-xl font-semibold"> Last Name</label>
       ...
       />
        <label htmlFor="" className="text-xl mt-5 font-semibold">Password</label>
       <input
       required
        value={password}
        onChange={(e)=>{
       ...
       <input type="submit"
       className="mt-5  p-2 bg-zinc-900 text-white text-center text-xl  rounded " value="Creat Account"/>
